...
//            issueBook();
    ...
    public void showIssuedBokk(List<IssueBookDetails> issueBookDetails) {
    	int n=1;
        System.out.printf("%-20s %-15s","User Name","Book List");
        System.out.println();
        for (IssueBookDetails issueBookDetails2:issueBookDetails){
        	System.out.printf("%-20s",issueBookDetails2.getUserName());
        	for(Book book:issueBookDetails2.getBookList()) {
            System.out.printf("%-15s",n+++"."+book.getName()+"\n");
            System.out.println();
        	}
        	n=1;
        }
