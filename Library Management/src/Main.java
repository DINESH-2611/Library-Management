...
public class Main extends Choclate{
    public static void main(String[] args){
        Choclate c=new WhiteChoclate();
        c.flavour();
...
class WhiteChoclate extends Choclate{
    public static void main(String[] args) {
        System.out.println("White");
    }
    String color;
//    int  flavour()throws ClassCastException{
//        System.out.println("White");
//        return 0;
//    }
}
class DarkChoclate extends Choclate{
    public static void main(String[] args) {
        System.out.println("Dark");
    }
    String color;
//   int flavour()throws StringIndexOutOfBoundsException{
//        System.out.println("Dark");
//        return 0;
//    }
}